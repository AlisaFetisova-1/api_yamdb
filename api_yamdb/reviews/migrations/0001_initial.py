# Generated by Django 3.2 on 2023-03-25 15:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_index=True, max_length=256)),
                ('year', models.IntegerField(db_index=True, validators=[django.core.validators.MinValueValidator(0, message='Введите год нашей эры'), django.core.validators.MaxValueValidator(2023, message='Введите год не больше текущего')])),
